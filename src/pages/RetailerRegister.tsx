...
export const RetailerRegister: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formData.businessName.trim()) {
      errors.businessName = 'Business / Store Name is required.';
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const res = await authService.registerRetailer(formData);
      ...
      <div className="min-h-screen bg-[#F5F8FC] flex flex-col justify-center py-12 px-4 sm:px-6">
        <div className="max-w-md w-full mx-auto">
          <SuccessCard
            ...
            onContinueToLogin={() => navigate('/auth/retailer')}
          />
        </div>
      </div>
    );
  ...
  return (
    <AuthLayout
      category={category}
      title="Register as E-Commerce Retailer"
      subtitle="Onboard marketplace operations, e-commerce storefronts & seller desks"
      isRegister
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <InputField
          ...
          placeholder="e.g. BharatMart Online Marketplace Ltd."
        ...
        <InputField
          ...
          placeholder="e.g. Anand Kulkarni (Catalogue Operations)"
        ...
        <InputField
          ...
          placeholder="e.g. compliance@bharatmart.in"
        ...
        <PasswordInput
          ...
          placeholder="Create retailer password"
